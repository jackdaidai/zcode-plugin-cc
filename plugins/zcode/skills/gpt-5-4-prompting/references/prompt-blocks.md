...
Use these blocks selectively when composing ZCode or GPT-5.4 prompts.
...
Use when ZCode should act without asking routine questions.
...
Use when ZCode might otherwise guess.
