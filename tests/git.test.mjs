...
import { collectReviewContext, resolveReviewTarget } from "../plugins/zcode/scripts/lib/git.mjs";
...
test("collectReviewContext skips broken untracked symlinks instead of crashing", (t) => {
  ...
  try {
    ...
    if (error.code === "EPERM" || error.code === "EACCES") {
      t.skip(`symlinks require Developer Mode / admin on ${process.platform}`);
    }
    throw error;
  }
